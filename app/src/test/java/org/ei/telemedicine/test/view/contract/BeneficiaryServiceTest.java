...
import org.ei.telemedicine.service.BeneficiaryService;
...
public class BeneficiaryServiceTest {
    ...
    @Test
    public void testShouldFetchEcsFromEcCaseIds() throws Exception {
    ...
    @Test
    public void testShouldFetchBeneficiariesFromChildCaseIds() throws Exception {
    ...
    @Test
    public void testShouldFetchBeneficiariesFromMotherCaseIds() throws Exception {
