...
public class PNCClientPreProcessorTest extends AndroidTestCase{
    ...
    @Test
    public void testShould_properly_calculate_the_expected_visits_day_date_values() throws Exception {
    ...
    @Test
    public void testShouldGenerateViewElementsWhenTodayIsTheDeliveryDate() throws Exception {
    ...
    @Test
    public void testShouldGenerateViewElements_whenTodayIs2DaysFromDeliveryDate() throws Exception {
    ...
    @Test
    public void testShouldGenerateViewElements_whenTodayIs3DaysFromDeliveryDate_AndServiceIsProvidedOnDay2() throws Exception {
    ...
    @Test
    public void testShouldPopulateRecentlyProvidedServices() throws Exception {
