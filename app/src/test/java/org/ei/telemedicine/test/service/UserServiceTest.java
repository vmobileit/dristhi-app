...
public class UserServiceTest extends AndroidTestCase {
   ...
   /* @Test
    ...
    /*@Test
    public void testShouldRegisterANewUser() {
    ...
    /*@Test
    public void testShouldSwitchLanguageToKannada() throws Exception {
    ...
    @Test
    public void testShouldSwitchLanguageToEnglish() throws Exception {
